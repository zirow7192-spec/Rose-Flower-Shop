...
export function EventsPage() {
  const { t } = useLanguage();
  const service = t.services.events;
    ...
    <div className="min-h-screen">
      <section className="relative h-96 flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              'url(https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&cs=tinysrgb&w=1920)',
          }}
        >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ServiceInquiryForm serviceType="events" />
        </div>
      </section>
    </div>
  );
